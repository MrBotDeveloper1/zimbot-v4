...
//settings
global.owner = ['94716025918'] //owner number +27634090203
global.wame = ['94716025918'] 
global.pemilik = ['94716025918'] //owner number +27634090203
global.premium = ['94716025918'] //premium number +27634090203
global.pengguna = 'Sahan Sathsara' //username
global.footer = '24×7 PUBLIC USER BOT'
global.botnma = '24×7 PUBLIC USER BOT' //bot name
global.botname = '24×7 PUBLIC USER BOT'
global.ownernma = 'Sahan Sathsara' //owner name
global.packname = 'Pack 01' //sticker package name
global.author = 'Sahan Sathsara' //sticker author name
...
global.mess = {
    ...
    botAdmin: '*24×7 PUBLIC USER BOT must be admin first!*',
    owner: '*this feature is only for 24×7 PUBLIC USER BOT owner*',
    group: '*Feature is only for groups!*',
    grouponly: '*Group Mode Only*',
    private: 'Features Used Only For Private Chat!',
    bot: 'This feature in only for the bot number',
    wait: '*whoa wait a moment 24×7 PUBLIC USER BOT proccessing*',
